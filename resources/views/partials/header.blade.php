                        ...
                        <div class="">
                            ...
                            <form class="navbar-form pull-left" role="search">
                                <div class="form-group">
                                    <input type="search" class="form-control search-bar " placeholder="Type here for search...">
                                </div>
                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                ...
                                <li class="dropdown">
                                    <a href="" class="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="true"><img src="{{ asset('/'.auth()->user()->photo) }}" alt="user-img" class="img-circle"> </a>
